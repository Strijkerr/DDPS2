...
if pid > 0 :
    process = subprocess.Popen(['ssh', '{master}', 'python3', '~/DDPS2/helloworld.py', '{json_dictionary}'], shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    stdout, stder = process.communicate(json_dictionary) # Blocking
