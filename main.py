...
if pid > 0 :
    process = subprocess.Popen(f"ssh {master} python3 ~/DDPS2/helloworld.py {location} {args.partitions} {json.dump(workers)}", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
