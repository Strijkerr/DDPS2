...
#> Times/single_system_1000000000.txt
while [ $counter -le 9 ]
do
...
#python3 create_data.py --seed $counter --sequence_length 1000000000 | grep "time" | cut -d ":" -f 2 | cut -d " " -f 2 &>> Times/single_system_1000000000.txt
((counter++))
done