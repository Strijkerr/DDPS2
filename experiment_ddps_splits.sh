...
counter=0
while [ $counter -le 2 ] # Change back to 9 after
do
python3 create_data.py --seed $counter --sequence_length 10000000 --measure_performance False > /dev/null # Change to 10^8 after
